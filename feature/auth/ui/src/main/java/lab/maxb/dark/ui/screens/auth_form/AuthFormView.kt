...
import lab.maxb.dark.ui.utils.InputOptions
import lab.maxb.dark.ui.utils.getPasswordTransformation
import lab.maxb.dark.ui.utils.keyboardClose
...
private fun ApplySideEffects(
    ...
    SideEffects(effects, onConsumed) {
        ...
        On<Ui.SideEffect.Authorized>(true) {
            navigator.navigateWelcomeScreen(AuthScreenDestination)
        }
